...
import com.sparta.springcore.model.UserInfo;
...
// 테스트 User 생성
        UserInfo testUser = new UserInfo("슈가", passwordEncoder.encode("123"), "sugar@sparta.com", UserRoleEnum.USER);
...
// 검색어 당 관심상품 10개 등록
    ...
    private void createTestData(UserInfo user, String searchWord) throws IOException {
// 네이버 쇼핑 API 통해 상품 검색
